...
public class MqttInputFlowConfiguration {
    ...
    @Bean
    public IntegrationFlow mqttInputFlow(@NonNull final MessageChannel inputChannel,
                ...
                .<SensorMessage, Boolean>route(
                        ...
                        mapping -> mapping
                                ...
                                .subFlowMapping(false, sf -> sf
                                        .log(LoggingHandler.Level.INFO, "MQTT_FLOW", m -> "Sending to aggregator: " + m.getPayload())
    ...
    public MqttPahoMessageDrivenChannelAdapter mqttAdapter(MessageChannel mqttErrorChannel) {
        ...
        var adapter = new MqttPahoMessageDrivenChannelAdapter(brokerUrl, clientId, "sensor/temperature");
