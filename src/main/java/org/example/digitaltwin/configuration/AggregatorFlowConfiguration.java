...
public class AggregatorFlowConfiguration {
    ...
    @Bean
    public IntegrationFlow aggregatorFlow(@NonNull final MessageChannel inputChannel,
                                          @NonNull final MessageChannel outputChannel) {
